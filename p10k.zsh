# Generated by Powerlevel10k configuration wizard on 2020-04-06 at 15:32 EDT.
# Based on romkatv/powerlevel10k/config/p10k-lean-8colors.zsh, checksum 31864.
...
() {
  ...
  typeset -g POWERLEVEL9K_LEFT_PROMPT_ELEMENTS=(linux_icon context dir vcs newline prompt_char)
    # =========================[ Line #1 ]=========================
  ...
  POWERLEVEL9K_CUSTOM_PROMPT_ICON=''
  POWERLEVEL9K_CUSTOM_IP="echo $ip"
  POWERLEVEL9K_CUSTOM_IP_FOREGROUND=7
  POWERLEVEL9K_CUSTOM_IP_TUN="echo $ip_tun"
  POWERLEVEL9K_CUSTOM_IP_TUN_FOREGROUND=069
  ...
  # The right end of right prompt.i
  ...
  #typeset -g POWERLEVEL9K_LET_PROMPT_LAST_SEGMENT_END_SYMBOL=' ]'
